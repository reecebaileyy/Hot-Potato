...
export async function getServerSideProps() {
  ...
  const contract = new Contract('0xAb989B312e6e493c88Ac97b3808855afdf1C359D', ABI, provider);
          ...
          <div className={`w-full flex flex-col justify-center items-center col-start-3 col-span-4 md:w-2/3 lg:w-1/2 shadow-lg rounded-xl p-6 mb-8 transition-transform duration-500 ease-in-out transform hover:scale-105 ${darkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
            ...
            {getGameState == "Playing" || getGameState == "Final Stage" ?
              <>
                ...
                {remainingTime == 0 || remainingTime == null ? <p className='text-2xl'>TIME REMAINING: 0</p> : <p className='text-2xl'>TIME REMAINING: {remainingTime}</p>}
                ...
                <Link href="https://mumbai.polygonscan.com/address/0xAb989B312e6e493c88Ac97b3808855afdf1C359D" target='_blank' className="underline">
                  Smart Contract
                </Link>
              </>
              : getGameState == "Queued" ? (
                <>
                  ...
                  <div className='grid grid-cols-3 justify-center gap-4'>
                    ...
                    <Link href="https://mumbai.polygonscan.com/address/0xAb989B312e6e493c88Ac97b3808855afdf1C359D" target='_blank' className={`text-lg text-center underline ${darkMode ? 'text-white' : 'text-black'}`}>Smart Contract</Link>
